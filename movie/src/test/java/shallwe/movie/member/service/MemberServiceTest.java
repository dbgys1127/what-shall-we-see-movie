...
class MemberServiceTest {
    ...
    void is_save_member() {
        ...
        MemberDto.Response savedMember =memberService.createMember(memberDto);
    ...
    void is_exist_member() {
        MemberDto.Post memberDto = MemberDto.Post.builder().email("test@gmail.com").password("123!abc").build();
        MemberDto.Response savedMember =memberService.createMember(memberDto);
        MemberDto.Post memberDto1 = MemberDto.Post.builder().email("test@gmail.com").password("123!abc").build();

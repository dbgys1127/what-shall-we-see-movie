...
<head>
    ...
    <script>
        $(document).on("click", ".h-logout", function(){
            $.ajax({
                type : "POST",            
                url : "/process_logout",          
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item" id="h-movie">
                <a class="nav-link" id="h-movie" aria-current="page" href="/movie?page=1">영화</a>
              </li>
    <c:choose>
        ...
        <c:otherwise>
                ...
                <li class="nav-item">
                    <a class="nav-link h-logout" id="h-logout">로그아웃</a>
                </li>
            </ul>
